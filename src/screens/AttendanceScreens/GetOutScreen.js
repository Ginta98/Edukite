...
import { WHITE, GRAY_FONTCOLOR, PRIMARY_COLOR, BLACK, PINK_FONTCOLOR } from '../../constant/Colors';
class GetOutScreen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            country: '',
                    ...
                    <ScrollView
                        ...
                        <View style={{ flexDirection: 'row', width: '90%', height: scale(100) }}>
                            ...
                            <View style={{ width: '50%', height: '100%', justifyContent: 'center', alignItems: 'flex-start', marginLeft: scale(10) }}>
                                ...
                                >
                                    <Text style={[texts.h4, { color: PRIMARY_COLOR, fontWeight: 'bold', textAlign: 'left' }]}>Xuống xe: 34/50</Text>
                                </View>
                                <View
                                    style={{ marginBottom: scale(10) }}
                                >
                                    <Text
                                        ...
                                        style={[texts.h4, { color: PRIMARY_COLOR, fontWeight: 'bold', textAlign: 'left' }]}>Xuống xe tại bến: 5/50</Text>
                                </View>
                                <View
